...
export const testimonialsData = {
  metadata: {
    title: 'Testimonials | Curious Laddoos',
  ...
  testimonials: [
    { author: 'John Doe', role: 'CEO', company: 'Food Group', quote: 'Curious Laddoos transformed our business. Their strategic insights were invaluable.', avatar: '/themes/curious-hub/images/avatar-1.jpg' },
